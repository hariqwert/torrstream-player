            ...
            params: {
              expression: `
                (() => {
                  ...
                  const animeSpotlight = document.getElementById('animeHeroSliderContainer') ? true : false;
                  const animeSched = document.getElementById('animeScheduleSection') ? true : false;
                  const detailsModal = document.getElementById('detailsModal') ? true : false;

                  return JSON.stringify({
                    viewSectionsExist: status,
                    homeTop10Count: homeShelves,
                    animeSpotlightExists: animeSpotlight,
                    animeSchedExists: animeSched,
                    detailsModalExists: detailsModal
                  });
                })()
              `
            }
