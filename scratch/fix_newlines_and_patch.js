...
if (filterGridPattern.test(html)) {
    ...
    console.log('SUCCESS 1: Patched appendFilterGrid hover overlay!');
    patchedCount++;
} else {
...
if (top10Pattern.test(html)) {
    ...
    console.log('SUCCESS 2: Patched renderTop10Shelf hover overlay!');
    patchedCount++;
} else {
...
if (hollywoodPattern.test(html)) {
    ...
    console.log('SUCCESS 3: Patched loadHollywoodPremieres card button!');
    patchedCount++;
} else {
...
console.log(`Saved consumet.html with ${patchedCount} replacements!`);
