...
router.get('/fetch', async (req: Request, res: Response) => {
    const title = (req.query.title || req.query.q || '') as string;
    const imdbId = (req.query.imdb || req.query.imdb_id || '') as string;
    const tmdbId = (req.query.tmdb || '') as string;
    const season = (req.query.season || req.query.s || '1') as string;
    const episode = (req.query.episode || req.query.e || '1') as string;
