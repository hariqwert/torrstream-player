    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function initPlayer() {
                ...
                let resolvedSrc = src;
                if ((src.startsWith('http://') || src.startsWith('https://')) && !src.includes('live.php') && !src.includes('xtream.php') && !src.includes('/api/stream-proxy') && !src.includes('/stream?link=')) {
                ...
                function loadMpegTs(streamUrl) {
                    ...
                    video.addEventListener('error', function(e) {
                        ...
                        showPlayerError('Video Error: ' + (err ? err.code + ' - ' + err.message : 'Unknown'));
                    });
                    video.addEventListener('stalled', function() { console.warn('Video stalled'); });
                    video.addEventListener('waiting', function() { console.warn('Video waiting'); });
                    video.addEventListener('suspend', function() { console.warn('Video suspended'); });
                    video.addEventListener('canplay', function() { console.warn('Video canplay'); });
                                    });
                                }
                            }
                        });
